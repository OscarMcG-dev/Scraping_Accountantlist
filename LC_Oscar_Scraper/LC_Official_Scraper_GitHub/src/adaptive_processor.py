...
class AdaptiveScraperProcessor:
    ...
    def __init__(
        ...
        # Create shared OpenAI client once and reuse it
    ...
    async def process_batch(
        ...
        async def process_with_semaphore(url) -> Tuple[Optional[CompanyData], Optional[OutOfScopeRecord], Optional[LowConfidenceRecord]]:
